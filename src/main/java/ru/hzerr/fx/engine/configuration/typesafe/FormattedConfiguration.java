package ru.hzerr.fx.engine.configuration.typesafe;
...
public class FormattedConfiguration implements IFormattedConfiguration {
    ...
    public String getString(String path, Object o) {
        return StringUtils.replaceOnce(config.getString(path), "{}", o.toString());
    }

    @Override
    public String getString(String path, Object... args) {
        return replace(config.getString(path), args);
    }
    ...
    public IFormattedConfiguration getConfig(String path) {
        return new FormattedConfiguration(config.getConfig(path));
    }
    ...
    public List<? extends IFormattedConfiguration> getConfigList(String path) {
        return config.getConfigList(path).stream().map(FormattedConfiguration::new).collect(Collectors.toList());
    }

...
public @interface FXEntity {
    ...
    /**
     * У каждого fxml свой отдельный bundle файл. Возвращает путь до данного файла
     * @return путь до bundle файла или языкового пакета, который должен быть загружен НА КОНКРЕТНОМ fxml
     */
